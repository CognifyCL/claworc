...
import { TabPlaceholder } from "@common/components/TabPlaceholder";
import EditInput from "@common/components/EditInput";
import { useInstanceBackups } from "@common/hooks/useBackups";
import SSHStatus from "@common/components/SSHStatus";
import SSHEventLog from "@common/components/SSHEventLog";
import SSHTroubleshoot from "@common/components/SSHTroubleshoot";
import {
  isValidCPU,
  isValidMemory,
  isValidResolution,
  cpuToMillis,
  memToBytes,
} from "@common/utils/resourceValidation";
import {
  useInstance,
  useStartInstance,
  useStopInstance,
...
import { useChatViewMode } from "@common/hooks/useChatViewMode";
import { stopBrowser } from "@common/api/browser";
...
export default function AgentDetailPage() {
  ...
  const renderProviderCard = (p: import("@common/types/instance").LLMProvider, isInstanceProvider: boolean) => {
